...
FinSist is a Flutter/Firebase household finance tracker for Indonesian families. It targets iOS, Android, and Web (all first-class). The product model is one household per user, shared household expenses/income/categories/budgets/cards/goals/investments, IDR only, locale id-ID.
